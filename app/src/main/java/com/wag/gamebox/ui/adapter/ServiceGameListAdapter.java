...
public class ServiceGameListAdapter extends RecyclerView.Adapter implements DownloadObserver {


    private List<ServiceGameListAdapter.ViewHolder> mHolders = new LinkedList<ServiceGameListAdapter.ViewHolder>();
    List<GameInfo> gameInfos;
    private Context context;
    private static DbManager db;
    private GameInfo gameInfo;
    private ServiceGameListAdapter.ViewHolder viewHolder;

    public ServiceGameListAdapter(Context context) {
        this.context = context;
        db = DbUtils.getDB();
    }

    public void setDatas(List<GameInfo> gameInfos) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new ServiceGameListAdapter.ViewHolder(view,gameInfos);
    }
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        ...
        viewHolder.tvOpenTime.setText(gameInfos.get(position).getOpen_time());
    ...
    public void onDownloadStateChanged(DownLoadManger manager, GameInfo info) {
        ListIterator<ServiceGameListAdapter.ViewHolder> iterator = mHolders.listIterator();
        while (iterator.hasNext()) {
            ServiceGameListAdapter.ViewHolder holder = iterator.next();
