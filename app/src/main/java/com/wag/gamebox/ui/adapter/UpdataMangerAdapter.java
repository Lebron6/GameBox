...
public class UpdataMangerAdapter extends RecyclerView.Adapter implements DownloadObserver {
    ...
    public UpdataMangerAdapter(Context context) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_updata_manger, parent, false);
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        ...
        viewHolder.tvOldV.setText(gameInfos.get(position).getOld_version());
        viewHolder.tvNewV.setText(gameInfos.get(position).getAndroid_version());
        viewHolder.tvUpdataDetails.setText(gameInfos.get(position).getUpdate_info());
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        @BindView(R.id.tv_old_v)
        TextView tvOldV;
        @BindView(R.id.tv_new_v)
        TextView tvNewV;
        @BindView(R.id.tv_updata_details)
        TextView tvUpdataDetails;
