...
import com.wag.gamebox.tools.BitmapHelper;
import com.wag.gamebox.ui.view.effect.AccordionTransformer;
import com.wag.gamebox.ui.view.effect.CubeTransformer;
import com.wag.gamebox.ui.view.effect.DefaultTransformer;
import com.wag.gamebox.ui.view.effect.DepthPageTransformer;
import com.wag.gamebox.ui.view.effect.InRightDownTransformer;
import com.wag.gamebox.ui.view.effect.InRightUpTransformer;
import com.wag.gamebox.ui.view.effect.RotateTransformer;
import com.wag.gamebox.ui.view.effect.ZoomOutPageTransformer;
...
//		 }
	  ...
	  for (int i = 0; i < imageUris.size(); i++)
	  {
	   ...
	   imageView.setScaleType(ScaleType.FIT_XY);// X和Y方向都填满
		  x.image().bind(imageView, BaseUrl.getInstence().ipAddress+imageUris.get(i), BitmapHelper.getBitmapUtils());
	   imageViewsList.add(imageView);
	   ImageView viewDot = new ImageView(getContext());
	   if (i == 0)
	   {
	    //viewDot.setBackgroundResource(R.drawable.dot_white);
	    viewDot.setBackgroundResource(R.drawable.indicator);
	   } else
	   {
	   // viewDot.setBackgroundResource(R.drawable.dot_light);
		   viewDot.setBackgroundResource(R.drawable.indicater_s);
	   }
	 ...
	 private void setImageBackground(int selectItems)
	 {
	  for (int i = 0; i < dotViewsList.size(); i++)
	  {
	   if (i == selectItems % dotViewsList.size())
	   {
	    ...
	    dotViewsList.get(i).setBackgroundResource(R.drawable.indicater_s);

	   } else
	   {
	    //dotViewsList.get(i).setBackgroundResource(R.drawable.dot_light);
	    dotViewsList.get(i).setBackgroundResource(R.drawable.indicator);
	   }
	  }
	 }
