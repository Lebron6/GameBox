...
public class NavitationLayout extends RelativeLayout {
    ...
    public void setViewPager(final Context context, String[] titles, ViewPager viewPager,
        ...
        setViewPager(context,null,titles,viewPager,unselectedcolor,setectedcolor,txtUnselectedSize,txtSelectedSize,currentPosition,widOffset,smoothScroll);
    }
     ...
     */
    public void setViewPager(final Context context, final View view, String[] titles, ViewPager viewPager, final int unselectedcolor, final int setectedcolor, int txtUnselectedSize, final int txtSelectedSize, final int currentPosition, int widOffset, boolean smoothScroll)
    {
